        ...
        case $1 in
           ...
           -cm  | --compact-mode )              OVN_COMPACT_MODE=true
            ...
            -adv | --advertise-default-network) ADVERTISE_DEFAULT_NETWORK=true
                                                  ;;
            -rui | --udn-isolation-mode)      UDN_ISOLATION_MODE=loose
                                                  ;;
...
print_params() {
     ...
     echo "UDN_ISOLATION_MODE= $UDN_ISOLATION_MODE"
...
set_default_params() {
  ...
  UDN_ISOLATION_MODE=${UDN_ISOLATION_MODE:-strict}
...
create_ovn_kube_manifests() {
  ...
  ./daemonset.sh \
    ...
    --udn-isolation-mode="${UDN_ISOLATION_MODE}" \
